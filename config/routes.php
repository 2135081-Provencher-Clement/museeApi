...
return function (App $app) {
    ...
    $app->post('/oeuvre', \App\Action\Oeuvre\OeuvreCreateAction::class)->add(\App\Middleware\ApiCheckMiddleware::class);
    $app->put('/oeuvre/{id}', \App\Action\Oeuvre\OeuvreUpdateAction::class)->add(\App\Middleware\ApiCheckMiddleware::class);
